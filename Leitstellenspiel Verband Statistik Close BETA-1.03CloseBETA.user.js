...
(function () {
    ...
    const currentVersion = "2.1.9"; // Aktuelle Version des Skripts
    ...
    function updateAllianceStatistics(data) {
        ...
        if (dropdownMenu.length === 0) {
            ...
            scriptInfoContainer.append(
                `<li><a href="#" style="color: white; font-size: 10px;">Version: 2.1.9 (Close BETA)</a></li>`
            );
            scriptInfoContainer.append(
