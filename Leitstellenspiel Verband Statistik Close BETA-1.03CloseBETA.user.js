...
(function () {
    ...
    const currentVersion = "2.2.4"; // Aktuelle Version des Skripts
    ...
    function notifyUpdate(newVersion) {
        const notificationHtml = `
            <div id="update-notification">
                Das Skript wurde auf Version ${newVersion} aktualisiert. Bitte laden Sie die Seite neu.
            </div>
        `;
    ...
    function updateAllianceStatistics(data) {
        ...
        if (dropdownMenu.length === 0) {
            ...
            scriptInfoContainer.append(
                `<li><a href="#" style="color: white; font-size: 10px;">Version: 2.2.4 (Close BETA)</a></li>`
            );
            scriptInfoContainer.append(
