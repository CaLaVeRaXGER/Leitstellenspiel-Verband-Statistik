...
(function () {
    ...
    const currentVersion = "2.2.3"; // Aktuelle Version des Skripts
    ...
    function updateAllianceStatistics(data) {
        ...
        if (dropdownMenu.length === 0) {
            ...
            scriptInfoContainer.append(
                `<li><a href="#" style="color: white; font-size: 10px;">Version: 2.2.3 (Close BETA)</a></li>`
            );
            scriptInfoContainer.append(
