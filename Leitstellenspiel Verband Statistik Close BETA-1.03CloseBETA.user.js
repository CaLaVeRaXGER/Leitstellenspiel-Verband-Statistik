...
(function () {
    ...
    const currentVersion = "3.2 (Hotfix)"; // Aktuelle Version des Skripts
    ...
    function updateAllianceStatistics(data) {
        ...
        if (dropdownMenu.length === 0) {
            ...
            scriptInfoContainer.append(
                `<li><a href="#" style="color: white; font-size: 10px;">Version: 3.2 (Hotfix)</a></li>`
            );
            scriptInfoContainer.append(
